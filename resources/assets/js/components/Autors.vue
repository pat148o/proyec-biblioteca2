                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <span class="help-block"
                                        >(*) Ingrese el nombre del Autor</span
                                    >
                                </div>
                                <label class="col-md-3 mx-sm-1">Pais</label>
        ...
        listAut: function(page, criterio, buscar) {
            ...
            axios
                ...
                .then(function(response) {
                    ...
                    me.arrayDatos = respuesta.autors.data;
